...

{
  ...
  programs.zellij = {
    ...
    settings = {
      ...
      theme = "sonokai";
      web_client.theme = {
        foreground = [ 225 227 228 ]; cursor        = [ 225 227 228 ];
        background = [  42  47  56 ]; cursor_accent = [  42  47  56 ];
        selection_background = [ 61 68 85 ];
        black   = [  42  47  56 ]; bright_black   = [ 130 138 154 ];
        red     = [ 255 101 120 ]; bright_red     = [ 255 101 120 ];
        green   = [ 157 210 116 ]; bright_green   = [ 157 210 116 ];
        yellow  = [ 234 203 100 ]; bright_yellow  = [ 234 203 100 ];
        blue    = [ 246 156  94 ]; bright_blue    = [ 246 156  94 ];
        magenta = [ 186 156 243 ]; bright_magenta = [ 186 156 243 ];
        cyan    = [ 114 204 232 ]; bright_cyan    = [ 114 204 232 ];
        white   = [ 225 227 228 ]; bright_white   = [ 225 227 228 ];
      };
    };
    themes.sonokai.themes.sonokai = {
      fg    = "#5a6477"; red    = "#ff6d7e"; cyan    = "#7ad5f1";
      bg    = "#424b5b"; orange = "#f69c5e"; blue    = "#72cce8";
      black = "#333846"; yellow = "#eacb64"; magenta = "#ba9cf3";
      white = "#828a9a"; green  = "#a5e179";
    };
    layouts.compact = ''
      layout {
        pane
